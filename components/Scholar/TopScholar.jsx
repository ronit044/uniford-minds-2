...
function TopScholar() {
    ...
    return (
        <>
            <h1 className="w-11/12 mx-auto mb-2 mt-16 text-3xl">Meet Our Top Scholars</h1>
            <p className="w-11/12 mx-auto mb-10 ">A concise and concrete summary of the research problem you seek to address</p>
                            ...
                            oppurtunityData.map((item, idx) => {
                                return <div className=" overflow-hidden p-5" key={idx}>
                                    <div className="p-5 border border-black rounded-2xl flex flex-col gap-4">
                                        <Image src={item.img} className="rounded-full h-20 w-20" />
                                        <h1 className="text-2xl" style={{
                                            backgroundColor: item.bgColor
                                        }} >{item.title}</h1>
                                        <p className="text-sm">{item.content}</p>
                                        <button className="rounded-2xl bg-primaryGreen p-2 text-white">Learn more</button>
                                    </div>
                                </div>
                            })
                        }
